...
- **El comportamiento ya definido de la Guía IA (`AI_PHILOSOPHY.md`)** — personalidad, principios no negociables, jerarquía de priorización, cómo razona y decide — sigue vigente sin cambios. Esta fase no lo rediseña: le da, por primera vez, memoria real con la que operar.
