...
## Próxima fase: implementación del ecosistema completo — plan y decisiones estratégicas aprobados, a la espera de la propuesta de ejecución de la Fase 1
...
1. Unificación del modelo de datos fundacional (Actor, Publicación, Interacción, Ciudad) + línea base de privacidad y consentimiento
2. Verificación robusta de negocios (vigencia anual sin cobro automático) + roles granulares
