...
|---|---|---|---|---|
| A1 | Infraestructura Supabase de producción operativa | Las 46 migraciones aplicadas sin error, en orden, contra el proyecto real; cada tabla nueva responde a una consulta real | Log de migración + captura de esquema real | Pendiente |
